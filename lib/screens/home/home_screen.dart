                ...
                builder: (context, state) {
                  if (state is SpeechListening) {
                    return Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.mic, color: Colors.red.shade300, size: 20),
                          SizedBox(width: 12),
                          Text(
                            'Đang lắng nghe...',
                            style: TextStyle(
                                ...
                                ListView(
                                  ...
                                  children: [
                                    ...
                                    _buildModernDeviceCard(
                                      ...
                                      onChanged: (value) {
                                        context.read<DeviceCubit>().toggleFan(
                                          value,
                                        );
                                      },
                                      gradientColors: [
                                    ...
                                    _buildModernDeviceCard(
                                      ...
                                      value: state.acState,
                                      onChanged: (value) {
                                        context.read<DeviceCubit>().toggleAC(
                                          value,
                                        );
                                      },
                                      gradientColors: [
                                    ...
                                    _buildModernDeviceCard(
                                      ...
                                      title: 'Cửa',
                                      subtitle: 'Cửa chính',
                                      value: state.doorAngle == 90,
                                      onChanged: (value) {
                                        context.read<DeviceCubit>().toggleDoor(
                                          value,
                                        );
                                      },
                                      gradientColors: [
      ...
      builder: (context, state) {
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const RfidCardsScreen()),
            );
          },
          child: Card(
            elevation: 2,
