                  ...
                  children: [
                    ...
                    BlocBuilder<RfidCubit, RfidState>(
                      builder: (context, state) {
                        final cards = state is RfidLoaded
                            ? state.cards
              ...
              Expanded(
                child: BlocConsumer<RfidCubit, RfidState>(
                  ...
                  builder: (context, state) {
                    ...
                    final isAddingCard = state is RfidLoaded && state.isAddingCard;
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              onPressed: isAddingCard
                                  ? () {
                                    context.read<RfidCubit>().cancelAddingCard();
                                  }
                                  : () {
                                    context.read<RfidCubit>().startAddingCard();
                                  },
                              icon: Icon(
                          ...
                          child: cards.isEmpty
                              ...
                              : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return _buildCardItem(context, card, index);
                                },
                              ),
                        ),
                      ],
